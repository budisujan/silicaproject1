const outputLog = document.getElementById('output');
    ...
    "morning_star": {
        ...
        link: "https://drive.google.com/uc?export=download&id=1jjGMldRyG8rNn8Tvu-SbpT5t7ZSbpD_8",
    ...
    "outer_space": {
        ...
        link: "https://drive.google.com/uc?export=download&id=1K_8jr8mLZvX0kS7u0VmQlICll8B9hHwV",
        desc: "user:l_richer"
    },
    "dark_memories": {
        serial: "65a#Y4",
        file: "SILICA_AI_1990.avi",
        link: "https://drive.google.com/uc?export=download&id=1CGyz95asNjfhZFTwD7F_oUi4_wYNeyfO",
        desc: "user:t_anderson"
    },
    "soul_symphony": {
        serial: "65a#Y4",
        file: "DEMO_HELENA.avi",
        link: "https://drive.google.com/uc?export=download&id=1Reta4jJtR6g6XqCsc4Hbf5WF2bqysvzP",
        desc: "user:h_moreau"
    },
    "phoenix_fire": {
        serial: "65a#Y4",
        file: "CLODES_NOTE.raw",
        link: "https://drive.google.com/uc?export=download&id=1RY69BYlc4idU9e84IkVvXtRp2fqYvulE",
        desc: "user:h_clode"
    }
};
    ...
    function showHelp() {
        if (!isAuth) {
            ...
            // Menampilkan daftar semua unit dari objek silicaAuth
